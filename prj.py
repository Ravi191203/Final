...
class Bill_App:
    ...
    # ===============Tax================================
        ...
        cname_txt = Entry(F1, width=15, textvariable=self.cust_name, font=("Bradley Hand ITC", 15,"bold"), bd=7, relief=SUNKEN).grid(row=0,
                                                                                                               column=1,
                                                                                                               padx=10,
                                                                                                               pady=5)

        cphn_lbl = Label(F1, text="Phone Number", bg=bg_color, fg="black", font=("times new roman", 15, "bold")).grid(
        ...
        c_bill_lbl = Label(F1, text="Bill Number", bg=bg_color, fg="black",
        ...
        bath_lbl = Label(F2, text="Bath Soap", font=("Bradley Hand ITC", 18, "bold"), bg=bg_color, fg="black").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")
        bath_txt = Entry(F2, width=10, textvariable=self.soap, font=("times new roman", 18, "bold"), bd=5, relief=SUNKEN).grid(
            row=0, column=1, padx=10, pady=10)

        face_cream_lbl = Label(F2, text="Face Cream", font=("Bradley Hand ITC", 18, "bold"), bg=bg_color,
        ...
        face_wash_lbl = Label(F2, text="Face Wash", font=("Bradley Hand ITC", 18, "bold"), bg=bg_color,
        ...
        hair_spray_lbl = Label(F2, text="Hair Spray", font=("Bradley Hand ITC", 18, "bold"), bg=bg_color,
        ...
        hair_gel_lbl = Label(F2, text="Hair Gel", font=("Bradley Hand ITC", 18, "bold"), bg=bg_color,
        ...
        body_lotion_lbl = Label(F2, text="Body Lotion", font=("Bradley Hand ITC", 18, "bold"), bg=bg_color,
        ...
        m3_lbl = Label(F6, text="Total Cold Drink Price", bg=bg_color, fg="black",
        ...
        c3_lbl = Label(F6, text="Cold Drink Tax", bg=bg_color, fg="black",
    ...
    def on_exit(self):
        # Thank you message
        messagebox.showinfo("Thank You", "Thank you for using this Software! ....🙏")
        root.destroy()
